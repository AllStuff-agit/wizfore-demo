            ...
            <div className={styles.contactInfo}>
              ...
              <div className={styles.mapWrapper}>
                ...
                <div className={styles.map}>
                  ...
                  <img src="/images/map-placeholder.jpg" alt="위즈포레 지도" />
                </div>
              </div>
            </div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className={styles.formGroup}>
                    ...
                    >
                      ...
                      <option value="language-therapy">언어치료</option>
                      <option value="art-therapy">미술치료</option>
                      <option value="music-therapy">음악치료</option>
                      <option value="sensory-integration">감각통합</option>
                      <option value="special-pe">특수체육</option>
                      <option value="play-therapy">놀이치료</option>
                      <option value="psychomotor">심리운동</option>
                      <option value="counseling">심리상담</option>
                      <option value="day-activity">주간활동서비스</option>
                      <option value="after-school">방과후활동서비스</option>
